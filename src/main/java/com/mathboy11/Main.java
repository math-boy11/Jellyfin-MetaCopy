...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            HashMap<String, Object> sourceItemData = apiClient.getItemMetadata(configData.getProperty("userId"), configData.getProperty("sourceItemId"));
            HashMap<String, Object> targetItemData = apiClient.getItemMetadata(configData.getProperty("userId"), configData.getProperty("targetItemId"));
            ...
            apiClient.setItemMetadata(configData.getProperty("targetItemId"), targetItemData);
            ...
            if (Boolean.parseBoolean(configData.getProperty("copyImages"))) {
                ...
                ArrayList<HashMap<String, Object>> sourceImageList = apiClient.getItemImageList(configData.getProperty("sourceItemId"));
                ArrayList<HashMap<String, Object>> targetImageList = apiClient.getItemImageList(configData.getProperty("targetItemId"));
                ...
                for (HashMap<String, Object> image : targetImageList) {
                    ...
                    apiClient.deleteItemImage(configData.getProperty("targetItemId"), (String) image.get("ImageType"));
                }
                ...
                for (HashMap<String, Object> image : sourceImageList) {
                    ...
                    Integer imageIndex = (Integer) image.get("ImageIndex");
                    ...
                    byte[] imageData = apiClient.getItemImage(configData.getProperty("sourceItemId"), (String) image.get("ImageType"), imageIndex);
                    ...
                    apiClient.setItemImage(configData.getProperty("targetItemId"), (String) image.get("ImageType"), imageIndex, imageData);
                }
